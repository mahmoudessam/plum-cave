...
import { deriveBytesUsingArgon2id, hexStringToArray, pkcs7PaddingConsumed, computeTagForDataUsingHMACSHA512, compareUint8Arrays } from "@/app/cryptographicPrimitives/twoCiphersSilentMode";
...
const FileDecrypter: React.FC<FileDecrypterProps> = ({
  ...
  }, [encodedDecryptedFilename, t, encryptedFileContent, fileSalt, masterKey, randomlyGeneratedFileKey, numberOfIterationsForArgon2]);
